...
// 	protoc        v3.21.12
// source: internal/pb/pvz_v1/pvz.proto
...
func (ReceptionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_pb_pvz_v1_pvz_proto_enumTypes[0].Descriptor()
}

func (ReceptionStatus) Type() protoreflect.EnumType {
	return &file_internal_pb_pvz_v1_pvz_proto_enumTypes[0]
}
...
func (ReceptionStatus) EnumDescriptor() ([]byte, []int) {
	return file_internal_pb_pvz_v1_pvz_proto_rawDescGZIP(), []int{0}
}
...
func (x *PVZ) Reset() {
	*x = PVZ{}
	mi := &file_internal_pb_pvz_v1_pvz_proto_msgTypes[0]
...
func (x *GetPVZListRequest) Reset() {
	*x = GetPVZListRequest{}
	mi := &file_internal_pb_pvz_v1_pvz_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetPVZListRequest) Descriptor() ([]byte, []int) {
	return file_internal_pb_pvz_v1_pvz_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetPVZListResponse) Reset() {
	*x = GetPVZListResponse{}
	mi := &file_internal_pb_pvz_v1_pvz_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetPVZListResponse) Descriptor() ([]byte, []int) {
	return file_internal_pb_pvz_v1_pvz_proto_rawDescGZIP(), []int{2}
}
...
var File_internal_pb_pvz_v1_pvz_proto protoreflect.FileDescriptor

const file_internal_pb_pvz_v1_pvz_proto_rawDesc = "" +
	"\n" +
	"\x1cinternal/pb/pvz_v1/pvz.proto\x12\x06pvz.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"r\n" +
	"\x03PVZ\x12\x0e\n" +
	...
	"PVZService\x12C\n" +
	"\n" +
	"GetPVZList\x12\x19.pvz.v1.GetPVZListRequest\x1a\x1a.pvz.v1.GetPVZListResponseB\x1bZ\x19internal/pb/pvz_v1;pvz_v1b\x06proto3"

var (
	file_internal_pb_pvz_v1_pvz_proto_rawDescOnce sync.Once
	file_internal_pb_pvz_v1_pvz_proto_rawDescData []byte
)

func file_internal_pb_pvz_v1_pvz_proto_rawDescGZIP() []byte {
	file_internal_pb_pvz_v1_pvz_proto_rawDescOnce.Do(func() {
		file_internal_pb_pvz_v1_pvz_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_pb_pvz_v1_pvz_proto_rawDesc), len(file_internal_pb_pvz_v1_pvz_proto_rawDesc)))
	})
	return file_internal_pb_pvz_v1_pvz_proto_rawDescData
}

var file_internal_pb_pvz_v1_pvz_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_internal_pb_pvz_v1_pvz_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_internal_pb_pvz_v1_pvz_proto_goTypes = []any{
...
var file_internal_pb_pvz_v1_pvz_proto_depIdxs = []int32{
...
func init() { file_internal_pb_pvz_v1_pvz_proto_init() }
func file_internal_pb_pvz_v1_pvz_proto_init() {
	if File_internal_pb_pvz_v1_pvz_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_pb_pvz_v1_pvz_proto_rawDesc), len(file_internal_pb_pvz_v1_pvz_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_internal_pb_pvz_v1_pvz_proto_goTypes,
		DependencyIndexes: file_internal_pb_pvz_v1_pvz_proto_depIdxs,
		EnumInfos:         file_internal_pb_pvz_v1_pvz_proto_enumTypes,
		MessageInfos:      file_internal_pb_pvz_v1_pvz_proto_msgTypes,
	}.Build()
	File_internal_pb_pvz_v1_pvz_proto = out.File
	file_internal_pb_pvz_v1_pvz_proto_goTypes = nil
	file_internal_pb_pvz_v1_pvz_proto_depIdxs = nil
}
